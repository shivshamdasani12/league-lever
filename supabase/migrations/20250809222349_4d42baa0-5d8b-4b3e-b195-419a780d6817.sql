...
-- 1) Profiles (independent of league membership)
...
-- 3) Now that tables exist, define helper function
...
-- Enable RLS and policies for leagues and members
